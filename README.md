...
❗IMPORTANTE: Visual Studio Code com a extensão Live Sass Compiler instalada
...
### 2. Compilar o SCSS (No VS Code)

- Abra o arquivo style/style.scss
- Clique no botão "Watch Sass" na barra inferior do VS Code
- Ou pressione F1 e digite "Live Sass: Watch Sass"
...
- Compilar uma vez: F1 → "Live Sass: Compile Sass - No Watch Mode"

## Características do Projeto 🤖

- Design responsivo para todos os dispositivos
- Interface limpa e moderna
- Cores que remetem à natureza e sustentabilidade
